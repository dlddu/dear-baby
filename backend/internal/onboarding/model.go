...
// through the case-branching onboarding (CaseKind, OnboardedAt), the
// home-screen coachmark (VoiceCoachmarkDismissedAt), and the first record
// + AI preview (FirstRecordAt, AIPreview).
