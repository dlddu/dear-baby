...
CREATE TABLE onboarding (user_id TEXT PRIMARY KEY, due_date TEXT, onboarded_at TEXT, voice_coachmark_dismissed_at TEXT, first_record_at TEXT, ai_preview TEXT, is_pregnant BOOLEAN, has_children BOOLEAN, multiple_pregnancy BOOLEAN, updated_at TEXT NOT NULL DEFAULT (datetime('now')));
