...
// TestPatchMe_DueDateRejected guarantees the deprecated due_date payload
// no longer slips through — the case-branching funnel is the only path
// that finishes onboarding.
