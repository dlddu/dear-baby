...
// *onboarding.Store. Today the only PATCH /me operation is the home-screen
// voice-coachmark dismissal — the case-branching onboarding submission has
// its own dedicated POST /onboarding/case endpoint.
...
// patchMeBody is the request body for PATCH /me. Only the home-screen
// coachmark dismissal flows through PATCH today; the onboarding case
// submission has its own endpoint.
type patchMeBody struct {
	DismissVoiceCoachmark *bool `json:"dismiss_voice_coachmark"`
}

// PatchMe dismisses the home voice coachmark. Any other field shape is
// rejected as 400.
