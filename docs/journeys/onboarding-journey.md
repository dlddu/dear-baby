...
특히 Case B(양육 + 임신)는 7화면이라는 객관적으로 긴 입력 흐름을 거치므로, 본 플로우의 페인포인트가 가장 집중되는 케이스다.
...
| 🌼 **Case B** | 7 (B0~B6) | "양 많은데 단계가 잘 나눠져 있어서 견딜 만하다" | B0/B3 안내 화면이 양육·임신 두 단계를 명시적으로 끊어줌 (단계 인디케이터 ①→②) | AC-006-03 |
