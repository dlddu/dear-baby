...
| 단계 | V-001 감정 보존 | V-002 부담 제거 | V-005 주차 맞춤 |
|---|:---:|:---:|:---:|
| 7-1. D-7 푸시 | ● | ●● | ●● |
| 7-2. 출산 확인 팝업 | ● | ●● | ● |
| 7-3. 출생일 입력 (모먼트) | ●●● | ● | ●●● |
...
**관찰**: 본 플로우는 V-005 (주차 맞춤)의 마지막 작동 지점이자, V-001 (감정 보존)이 가장 강하게 체험되는 모먼트(7-3)를 포함한다. 이후 플로우들은 V-005를 더 이상 활용하지 않고 V-001·V-003·V-006으로 무게중심을 옮긴다.
