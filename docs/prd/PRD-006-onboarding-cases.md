...
- **조건**:
  ...
  - **③ 기록 목적**
    - 아이별로 다른 목적을 선택할 수 있다 (아이별 선택 UI 제공)
    - 양육 아이는 정보 입력 직후 1:1 화면(B2-Purpose)에서 입력하고, 태아는 모든 입력이 끝난 뒤 일괄 화면(B6)에서 입력한다
...
- **조건**:
  ...
  - 기록 목적을 복수 선택한다 — 다자녀인 경우에도 1회만 묻고 모든 아이에 동일하게 적용한다 (아이별 개별 선택은 후속 작업)
