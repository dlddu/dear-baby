...
| 2026-05-05 | PRD-006 AC-006-01~04 (케이스 분기 온보딩) 구현 완료 | 미구현 | 구현 (TC-006-01~06 커버) |
...
- AC-006-05~07 출산 전환 플로우 구현 (D-7 푸시, 출산 확인 팝업, D+14 배너)
- AC-006-08~09 활성 아이 컨텍스트 (홈 상단 전환 탭, 탭별 재구성, 활성 아이 기준 주차/일수 표시)
