...
| 2026-05-05 | PRD-006 AC-006-01~04 (케이스 분기 온보딩) 구현 완료 — 마이그레이션 0008, `POST /onboarding/case`, `POST /onboarding/children/photo/upload-url`, 클라이언트 Q1·Q2·A1~A3·B0~B6·C1~C3 화면, Maestro Case A/B/C E2E 시나리오 추가 | 미구현 | AC-006-01~04 ✅ |

## 구현 상태 (PRD-006)

| AC | 영역 | 상태 |
|---|---|---|
| AC-006-01 (Q1·Q2 두 독립 체크 → 케이스 분기) | 케이스 분기 온보딩 | ✅ 구현됨 |
| AC-006-02 (Case A: 임신만) | 케이스 분기 온보딩 | ✅ 구현됨 |
| AC-006-03 (Case B: 양육+임신) | 케이스 분기 온보딩 | ✅ 구현됨 |
| AC-006-04 (Case C: 양육만) | 케이스 분기 온보딩 | ✅ 구현됨 |
| AC-006-05~07 (출산 전환 플로우) | 출산 전환 | ⏳ 미구현 |
| AC-006-08~09 (다자녀 컨텍스트 — 아이 전환 탭) | 다자녀 | ⏳ 미구현 |
| AC-006-10 (설정 탭 "아이 추가" 진입점) | 다자녀 | ⏳ 후속 검토 |
