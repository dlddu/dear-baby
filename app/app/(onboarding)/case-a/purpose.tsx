// A3 — 기록 목적 (Case A)
//
// Multi-select, applied to every fetus child. On submit we POST
...
export default function CaseAPurpose() {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      await clearDraft();
      // AuthGate flips to authenticated; explicit replace handles fast-path.
      router.replace('/(tabs)');
    } catch (err) {
