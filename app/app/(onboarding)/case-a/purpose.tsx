// A3 — 기록 목적 (Case A는 모든 태아에 동일 목적 복제 저장)
...
export default function CaseAPurposeScreen() {
  ...
  const onNext = async () => {
    ...
    setSubmitting(true);
    try {
      // Replicate the picked purposes onto every fetus child, then
      ...
      // AuthGate redirects to /(tabs) once status flips.
    } catch (e) {
