// A2 — 태아 정보 입력 (PRD-006 AC-006-02)
// Reused N times via the ?index= search param when count > 1 (다태아).
          ...
          <View style={styles.heroRow}>
            <View style={styles.hero}>
              ...
              <Text variant="emotion" color="secondary" style={styles.helper}>
                지금 만나고 있는 아이의 정보를 적어주세요.
              </Text>
            </View>
            {total > 1 ? <RepeatBadge n={index + 1} of={total} testID="case-a-fetus-badge" /> : null}
          </View>
          <FetusForm values={values} onChange={setValues} testIDPrefix="case-a-fetus" />
        </ScrollView>
