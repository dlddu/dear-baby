// PRD-006 Case C · 3/3 — 기록 목적 (복수 선택). AC-006-04.
// Case A 와 동일하게 모든 인덱스에 같은 셋을 적용한 뒤 complete.
...
export default function CaseCPurpose() {
  ...
  const onFinish = async () => {
    ...
    try {
      ...
      console.warn('[onboarding] case C submit failed', e);
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top', 'bottom']} testID="case-c-purpose">
      <StepHeader progress="Case C · 3/3" />
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Button
          ...
          onPress={onFinish}
          testID="case-c-finish"
        />
        {error ? (
          <Text variant="caption" color="coral" style={styles.error} testID="case-c-error">
            {error}
          </Text>
        ) : null}
      </ScrollView>
