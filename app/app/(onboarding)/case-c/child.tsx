// C2 — 양육 아이 정보 (반복). Case B 의 child 화면과 동일한 입력 필드.
...
export default function CaseCChild() {
  ...
  return (
    <OnboardingScreen
      ...
      cta={{ title: ctaTitle, onPress: onNext, disabled: !isValid, testID: 'c2-next' }}
    ...
    >
      ...
      <View style={{ gap: spacing[2] }}>
        ...
        <GenderPicker value={gender} onChange={setGender} testID="c2-gender" />
      </View>
      <DateField
        label="생년월일"
        value={birth}
