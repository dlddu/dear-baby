// B2 — 양육 아이 정보 입력 (반복) (PRD-006 AC-006-03 ①)
...
export default function CaseBChild() {
  ...
  return (
    <CaseAccentTheme case="B">
      <SafeAreaView style={styles.safe} edges={['top', 'bottom']} testID="onboarding-case-b-child">
        <OnboardingProgressBar n={3} of={7} label="Case B · 1단계 ②" />
        <ScrollView style={styles.scroll} contentContainerStyle={styles.body} keyboardShouldPersistTaps="handled">
          <View style={styles.heroRow}>
            ...
            {total > 1 ? <RepeatBadge n={index + 1} of={total} testID="case-b-child-badge" /> : null}
          </View>
          <ChildForm values={values} onChange={setValues} testIDPrefix="case-b-child" />
        </ScrollView>
