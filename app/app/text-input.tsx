...
import { createEntry } from '../src/api/diary';
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>텍스트로 작성</Text>
        <Pressable
      ...
      <ScrollView style={styles.body} keyboardDismissMode="interactive">
        ...
        <View style={styles.metaRow}>
          <View style={styles.metaTag}>
            <Text style={styles.metaText}>📅 {formatDateTag()}</Text>
          </View>
          <View style={styles.metaTag}>
            <Text style={styles.metaText}>✏️ 텍스트 기록</Text>
          </View>
        </View>
