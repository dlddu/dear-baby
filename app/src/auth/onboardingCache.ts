...
// Legacy key from the original Stage 1 due-date funnel — kept here so
// clearOnboardingCache() can sweep it on existing installs that still
// have the value cached. Read paths no longer reference it.
