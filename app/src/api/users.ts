...
// patchMe updates the authenticated user via PATCH /me. Today the only
// supported payload is `{dismiss_voice_coachmark: true}`, called when the
// user closes the home-screen voice-record coachmark.
